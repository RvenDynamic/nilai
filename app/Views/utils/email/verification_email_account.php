...
<head>
    ...
    <title>polres account verify</title>
        ...
        <tr>
            ...
            <td class="container">
                <div class="content">
                    ...
                    <span class="preheader">silahkan klik tombol di bawah untuk verifikasi account
                        anda.</span>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                        ...
                        <tr>
                            <td class="wrapper">
                                ...
                                <p>
                                    Halo <b><?= $username ?></b>, Kami admin dari aplikasi
                                    <b>Rekap Nilai Polres Pekalongan</b>. Untuk mengaktifkan
                                    akun anda mohon untuk meng-klik tombol di bawah ini.
                                </p>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left">
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr class="verify" style="
                                  animation: scale-up-center 1s
                                    cubic-bezier(0.4, 0, 0.2, 1) both;
                                ">
                                                            <td>
                                                                <a
                                                                    href="<?= base_url('verify-account/'. $verification_code) ?>">Click
                                                                    Verify</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
