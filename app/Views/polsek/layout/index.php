...
<head>
    ...
    <title>Polsek/Satfung | <?= $title ?></title>
    <link rel="icon" href="<?=base_url("/icon.ico")?>" type="image/ico">

    <!--  Essential META Tags -->
    <meta property="title" content="Polres Pekalongan Rekap Nilai">
    ...
    <meta property="description" content="Applikasi untuk rekap nilai e-mental & e-rohani Polres Pekalongan.">
...
<body class="bg-gray-50 dark:bg-gray-600">
    <!-- navbar  -->
    <?= $this->include("polsek/layout/navbar") ?>
